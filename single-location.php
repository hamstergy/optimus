            ...
            <div class="container">
                ...
                <div class="slider-content">
                    <div class="banner-content">
                        <<?php the_field('tag'); ?> class="banner-title"><?php the_field('title'); ?></<?php the_field('tag'); ?>>
                        <<?php the_field('tag_dec'); ?> class="banner-text _light-text"><?php the_field('kratkoe_opisanie'); ?></<?php the_field('tag_dec'); ?>>
